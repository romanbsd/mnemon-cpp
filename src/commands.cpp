...
int run_mnemon(int argc, char** argv) {
  ...
  setup->add_option("--target", setup_target)->description("claude-code | codex | cursor | trae | qoder | qoderwork | codebuddy | workbuddy | kimi | opencode | openclaw | nanobot | pi | hermes");
